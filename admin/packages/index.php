...
<body>
    ...
    <section class="services">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 35px; margin-bottom: 15px">
            <h1>Package List</h1>
            <a href="add.php" class="btn">Add Package</a>
        </div>
                    ...
                    <?php if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($result = mysqli_fetch_assoc($query)) { ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $result['min_guest'] . ' - ' . $result['max_guest']; ?></td>
                                ...
                                <td>
                                    <a href="update.php?package=<?php echo $result['id']; ?>"><i class="fa fa-edit"></i></a>
                                    &nbsp; | &nbsp;
                                    <a href="delete.php?package=<?php echo $result['id']; ?>" style="color: red"><i class="fa fa-trash-can"></i></a>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td colspan="7" style="text-align: center; color: red; font-weight: bold">No package data found!</td>
                        </tr>
                    <?php } ?>
                    <tr>
